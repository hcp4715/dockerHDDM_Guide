...
def run_m0(id, df=None, samples=None, burn=None, thin=1, save_name="ms0"): 
...
def run_m1(id, df=None, samples=None, burn=None, thin=1, save_name="ms1"): 
#     print('running model %i'%id);
    import hddm
...
def run_m2(id, df=None, samples=None, burn=None, thin=1, save_name="ms2"): 
#     print('running model %i'%id);
    import hddm
...
def run_m3(id, df=None, samples=None, burn=None, thin=1, save_name="ms3"): 
#     print('running model %i'%id);
    import hddm
...
def run_m4(id, df=None, samples=None, burn=None, thin=1, save_name="ms4"): 
#     print('running model %i'%id);
    import hddm
...
def run_m5(id, df=None, samples=None, burn=None, thin=1, save_name="ms5"): 
#     print('running model %i'%id);
    import hddm
...
def run_m6(id, df=None, samples=None, burn=None, thin=1, save_name="ms6"): 
    import hddm
...
def run_m7(id, df=None, samples=None, burn=None, thin=1, save_name="ms7"): 
    import hddm
